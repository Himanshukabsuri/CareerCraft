          ...
          {formData.education.map((edu, index) => (
            ...
            >
              <input
                ...
                value={edu.degree}
                onChange={(e) =>
                  handleNestedChange(e, index, "education", "degree")
                }
                className="border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <input
                ...
                onChange={(e) =>
                  handleNestedChange(e, index, "education", "institution")
                }
                className="border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <input
                ...
                onChange={(e) =>
                  handleNestedChange(e, index, "education", "start_year")
                }
                className="border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <input
                ...
                value={edu.end_year}
                onChange={(e) =>
                  handleNestedChange(e, index, "education", "end_year")
                }
                className="border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
            </div>
              ...
              .map((s, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() => {
                      const skillsArr = formData.skill
                        .split(",")
                        .filter((sk) => sk.trim() !== "");
          ...
          {formData.projects.map((proj, index) => (
            <div key={index} className="space-y-3 mb-4">
              <input
                ...
                value={proj.title}
                onChange={(e) =>
                  handleNestedChange(e, index, "projects", "title")
                }
                className="w-full border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <textarea
                ...
                onChange={(e) =>
                  handleNestedChange(e, index, "projects", "description")
                }
                className="w-full border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <input
                ...
                value={proj.github}
                onChange={(e) =>
                  handleNestedChange(e, index, "projects", "github")
                }
                className="w-full border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
              <input
                ...
                value={proj.live}
                onChange={(e) =>
                  handleNestedChange(e, index, "projects", "live")
                }
                className="w-full border p-3 rounded-lg focus:ring-2 focus:ring-indigo-400"
              />
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          {formData.languages.map((lang, index) => (
            <input
              ...
              value={lang.name}
              onChange={(e) =>
                handleNestedChange(e, index, "languages", "name")
              }
          ...
          <button
            type="button"
            onClick={() => addField("languages", { name: "" })}
