        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <h5 className="text-lg font-semibold text-gray-700 border-b-2 border-green-500 pb-2 mb-4">Personal Details</h5>
            ...
            {/* Education Column */}
            <div className="space-y-4">
              <h5 className="text-lg font-semibold text-gray-700 border-b-2 border-blue-500 pb-2 mb-4">Education</h5>
            ...
            <div className="space-y-4">
              <h5 className="text-lg font-semibold text-gray-700 border-b-2 border-purple-500 pb-2 mb-4">Skills & Interests</h5>
