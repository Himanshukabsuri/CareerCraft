    ...
    const dummyTestimonialData = [
        {
            ...
            content: 'Amazing experience of my career with the help of Career Craft,they help me to find the right path.',
            rating: 4,
        },
        {
        ...
        },
        {
            ...
            name: 'Priyanshu Shah',
            title: 'Ai Developer',
            content: 'Fanaestic experience,i am absolutely satisfied becouse sagar does not satisfied me ,so my experiece is amazing. ',
            rating: 4,
        },
    ]
  return (
                ...
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        <div className="flex items-center gap-1">
                           {Array(5).fill(0).map((_,index)=>(<img key={index} src={star}
